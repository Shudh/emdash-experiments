...
const OPEN_FORM_STATES = ["application_under_review", "accepted_as_tenant", "moveout_requested"];
...
export const RENTAL_APPLICATION_FORM_BASIC_V1: WorkflowDefinition = validateWorkflowDefinition({
	...
	states: {
		application_under_review: {
			...
			descriptionByRole: {
				...
				applicant: "Your application form is under review. Please answer any open task cards.",
				renter: "Your application form is under review. Please answer any open task cards.",
			},
		...
		accepted_as_tenant: {
			...
			tone: "rented",
			descriptionByRole: {
				owner: "This application form was accepted. The applicant is now the tenant.",
		...
		moveout_requested: {
			...
			descriptionByRole: {
				...
				applicant: "Move-out is active. Please answer any open return-check task cards.",
				renter: "Move-out is active. Please answer any open return-check task cards.",
			},
			waitingMessageByRole: {
				owner: "No open task is pending. You may close move-out when required checks are complete.",
				renter: "No open task for you now. Waiting for the owner.",
			},
		},
		moveout_closed: {
			...
			descriptionByRole: {
				owner:
					"Move-out is closed. The asset is back under owner control and can be published again when ready.",
	...
	cardTypes: {
		info_ack_to_counterparty: {
			...
			ui: {
				...
				helpText: "Use this for plain information exchange. The other side acknowledges it.",
			},
			transitions: [],
		},
		info_ack_to_owner: {
			...
			ui: {
				...
				answerLabel: "Acknowledgement",
				submitLabel: "Send information card",
				helpText: "Use this for plain information exchange. The owner acknowledges it.",
			},
			transitions: [],
		},
		mcq_single: {
			...
			ui: {
				...
				helpText: "Generic task card. The prompt gives this card its business meaning.",
			},
			transitions: [],
		},
		mcq_single_required_evidence: {
			...
			ui: {
				...
				helpText: "Generic required task. The answering side must attach image/PDF evidence.",
			},
			transitions: [],
		},
		mcq_multi: {
		...
		mcq_multi_required_evidence: {
			...
			ui: {
				...
				defaultPrompt: "Please choose all matching options and attach evidence.",
				promptLabel: "Question",
				answerLabel: "Choices",
		...
		free_text: {
			...
			ui: {
				...
				helpText: "Generic text task. The prompt gives this card its business meaning.",
			},
			transitions: [],
		},
	...
	actions: {
		accept_as_tenant: {
			...
			confirmationMessage: "Accept this participant as tenant and reject other applications.",
		},
		request_moveout: {
			id: "request_moveout",
			...
			confirmationMessage: "Start move-out and move this asset into return pending.",
		},
		close_moveout: {
			id: "close_moveout",
