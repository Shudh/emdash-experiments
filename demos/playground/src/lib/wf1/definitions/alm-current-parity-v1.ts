...
const applicationStates = {
	...
	answer_received: {
		...
		descriptionByRole: {
			owner:
				"The renter has answered an owner request. You can ask more questions, counter, or accept terms.",
	...
	countered: {
		...
		descriptionByRole: {
			owner:
				"Counter terms were sent. You can still accept final terms if the offline discussion is complete.",
	...
	booked: {
		...
		descriptionByRole: {
			owner:
				"Terms are accepted. You can send booking/deposit task cards or explicitly start move-in.",
	...
	cardTypes: {
		...
		owner_question: {
			...
			ui: {
				...
				helpText:
					"Use this card for screening questions, document references, or owner clarification.",
			},
			transitions: [
				{
					when: "card_created",
					nextWorkflowState: "screening",
					nextAssetState: WF_ASSET_STATE.NEGOTIATING,
				},
