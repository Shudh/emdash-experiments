...
console.log("WF1 mock marketplace ready at http://127.0.0.1:4451");
});
NODE
...
echo "WF1 rental sandbox: http://localhost:4450/wf1"
echo "WF1 rental API: http://localhost:4450/api/wf1-rental"
...
echo "Owner Eva: owner_manual_created_1@example.com"
echo "Tenant Rakesh: tenant_manual_created_1@example.com"
