...
import { handleWorkflowRentalRoute } from "../../../../../../demos/playground/src/lib/wf1/api/handler.js";
import { KyselyWorkflowStore } from "../../../../../../demos/playground/src/lib/wf1/store/kysely-workflow-store.js";
...
function fail(error: unknown): Response {
	...
	console.error("[wf1-rental-fixture] API route failed", error);
	return Response.json(
